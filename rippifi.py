...
\__|  \__|\__|$$  ____/ $$  ____/ \__|\__|      \__|
              ...
              $$ |      $$ |                        
              \__|      \__|
                                              WiFi-Cracker by ancient modder """
Writertext(banner)
...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.rippifi/sessions/'
        self.pixiewps_dir = f'{user_home}/.rippifi/pixiewps/'
...
def usage():
    return """
rippifiPin 0.0.2 (c) by ancient-modder
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='rippifiPin 0.0.2 (c) by ancient-modder',
